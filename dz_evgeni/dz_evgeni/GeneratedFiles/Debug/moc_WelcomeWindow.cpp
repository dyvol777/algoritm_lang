...
void WelcomeWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->formula((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (WelcomeWindow::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WelcomeWindow::formula)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WelcomeWindow::formula(const QString & _t1)
{
